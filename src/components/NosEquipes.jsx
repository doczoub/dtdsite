...
import { faInstagram,faTwitter,faDribbble,faGoogle,faFacebookF} from '@fortawesome/free-brands-svg-icons'
import React from 'react'
import team1 from '../assets/img/DD.jpg'
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-wrap justify-center text-center mb-24">
              <div className="w-full lg:w-6/12 px-4">
                <h2 className="text-4xl font-semibold">Voici Notre Equipe</h2>
              ...
              <div className="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
                <div className="px-6">
                  ...
                  <div className="pt-6 text-center">
                    <h5 className="text-xl font-bold">Marie Catherine AYOMAN</h5>
